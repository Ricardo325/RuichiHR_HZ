...
<div id="main" >
    ...
    <form name=alipayment action=order/confirm method=post
          target="_blank">
...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        document.getElementById("WIDsubject").value = "标题";
        document.getElementById("WIDtotal_amount").value = "88888888";
    }
    GetDateNow();
</script>
</html>